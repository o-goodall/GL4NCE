...
const CATEGORY_STYLES: Record<EventCategory, string> = {
  ...
  diplomatic:     "bg-brand-100 text-brand-700 dark:bg-brand-900/30 dark:text-brand-300",
  extremism:      "bg-brand-100 text-brand-700 dark:bg-brand-900/30 dark:text-brand-200",
  economic:       "bg-brand-100 text-brand-700 dark:bg-brand-900/30 dark:text-brand-300",
  commodities:    "bg-brand-100 text-brand-700 dark:bg-brand-900/30 dark:text-brand-300",
  cyber:          "bg-brand-100 text-brand-700 dark:bg-brand-900/30 dark:text-brand-300",
  health:         "bg-brand-100 text-brand-700 dark:bg-brand-900/30 dark:text-brand-300",
  environmental:  "bg-brand-100 text-brand-700 dark:bg-brand-900/30 dark:text-brand-300",
  disaster:       "bg-brand-100 text-brand-700 dark:bg-brand-900/30 dark:text-brand-300",
  infrastructure: "bg-brand-100 text-brand-700 dark:bg-brand-900/30 dark:text-brand-300",
  crime:          "bg-orange-100 text-orange-900 dark:bg-orange-900/30 dark:text-orange-300",
  piracy:         "bg-orange-100 text-orange-900 dark:bg-orange-900/30 dark:text-orange-300",
